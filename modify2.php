  ...
  <p align="center">
    <?php 
     ...
     <form id="form1" name="form1" method="get" action="modify3.php">
        <table align="center" width="291" border="0">
          ...
          <tr>
           ...
           <tr>
            ...
            <td><input type="text" name="marks" id="number" value="<?php echo $result[5] ?>" /></td>
          </tr>
        </table>
        <p align="center">
          <label>
        ...
        <p align="center"><img onClick="javascript: history.go(-1)" border="0" src="images/1.png" alt="Go Back" onmouseover="this.src='images/1_MouseOver.png';" onmouseout="this.src='images/1.png';" /></p>
        <p align="center"><a href="./"><img border="0" src="images/2.png" onmouseover="this.src='images/2_MouseOver.png';" onmouseout="this.src='images/2.png';" /></a></p>
      </form>
